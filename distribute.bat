...
ucon64 -q --snes --chk mmx_msu1_emulator.sfc
ucon64 -q --mki=mmx_original.sfc mmx_msu1_emulator.sfc
copy mmx_msu1.ips MegaManX_MSU1
copy mmx_msu1_emulator.ips MegaManX_MSU1
